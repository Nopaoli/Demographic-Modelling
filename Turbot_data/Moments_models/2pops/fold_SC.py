...
# Secondary contact: split in two arbitrary constant Ne, asymmetric migration following secondary contact 
# n(para): 6
...
func=SC
upper_bound = [100,100,10,10,200,200]
...
# printing parameters 
print "RESULT","SC",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
