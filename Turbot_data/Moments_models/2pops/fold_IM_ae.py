...
# IM with ancestral population expansion: ancestral expansion, split in two arbitrary constant Ne, asymmetric migration 
# n(para): 5
...
func=IM_ae
upper_bound = [100,100,100,10,10,200,200]
...
# printing parameters 
print "RESULT","IM_ae",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
