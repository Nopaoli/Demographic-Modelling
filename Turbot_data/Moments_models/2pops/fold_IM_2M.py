...
# IM model : split in two arbitrary  Ne, asymmetric migration fand heterogeneous migration rates across the genome
# n(para): 8
...
func=IM_2M
upper_bound = [100,100,10,200,200,0.999,0.999,0.499]
lower_bound = [1e-3,1e-3,1e-3,1e-5,1e-5,1e-3,1e-3,1e-3]
...
# printing parameters 
print "RESULT","IM_2M",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
