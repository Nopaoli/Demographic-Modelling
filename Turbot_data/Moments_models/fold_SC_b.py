...
# Secondary contact model: Split,Bottleneck and growth in the Baltic Sea,  asymmetric migration following secondary contact
# n(para): 7
...
func=SC_b
upper_bound = [100,100,0.999,10,10,200,200]
...
# printing parameters 
print "RESULT","SC_b",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
