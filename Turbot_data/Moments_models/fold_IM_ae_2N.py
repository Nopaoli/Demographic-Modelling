...
# IM model:  ancestral pop expansion, split in two with constant Ne, asymmetric migration, linked selection 
# n(para): 7
...
def IM_ae_2N(params, ns):
    ...
    """
    nu_ae,nu1,nu2,Tae,T1,m12,m21,hrf,Q = params
...
func=IM_ae_2N
upper_bound = [100,100,100,10,10,200,200,0.999,0.499]
...
# printing parameters 
print "RESULT","IM_ae_2N",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
