...
# Isoation with migration: split in two arbitrary constant Ne, asymmetric migration 
# n(para): 5
...
func=IM
upper_bound = [100,100,10,200,200]
...
# printing parameters 
print "RESULT","IM",ind,len(params),opti,round,ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
