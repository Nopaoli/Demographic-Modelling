...
p_labels = "nu1,nu2,s,1,T2,m12,m21"
upper = [20,20,0.999,10,10,100,100]
...
for i in range(1,11):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "SC_b", SC_b, 4, 7, data_folded=False, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
