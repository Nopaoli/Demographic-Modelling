...
def SC_ae(params, ns):
	...
	nu2= pop size after after split of pop 2
...
upper = [20,20,20,10,10,10,100,100]
...
for i in range(1,11):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "SC_ae", SC_ae, 4, 8, data_folded=False, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
