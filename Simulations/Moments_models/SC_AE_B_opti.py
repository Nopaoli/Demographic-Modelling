...
def SC_ae_b(params, ns):
    """
    nu_ae= ancestral population size after expansion/contraction
	nu1= pop size after after split of pop 1
	s=size of pop 2 at time of split as a proportion of nu1
...
upper = [20,20,20,0.999,10,10,10,100,100]
...
for i in range(1,11):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "SC_ae_b", SC_ae_b, 4, 9, data_folded=False, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
