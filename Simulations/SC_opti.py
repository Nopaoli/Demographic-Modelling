...
for i in range(1,11):
	...
	Optimize_Functions.Optimize_Routine(data, prefix, "SC", SC, 4, 6, data_folded=False, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
