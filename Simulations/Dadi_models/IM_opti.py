...
upper = [20,20,10,10,5]
lower = [1e-3,1e-3,1e-5,1e-5,1e-3]
...
for i in range(1,4):
    ...
    Optimize_Functions.Optimize_Routine(data, pts, prefix, "IM", IM, 3, 5, data_folded=False, param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds,optimizer="log")
